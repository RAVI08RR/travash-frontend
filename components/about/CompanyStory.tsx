    ...
    <section className="py-10 sm:py-12 lg:py-16 bg-white font-['Plus_Jakarta_Sans',sans-serif] border-b border-gray-100">
      <div className="max-w-[80rem] mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-12 gap-8 lg:gap-12 items-center">
          {/* Left Column: Eyebrow, Title, Generated Image */}
              ...
              <div className="relative aspect-[16/10] w-full">
                ...
                <div className="absolute bottom-0 left-0 right-0 p-3.5 sm:p-5 flex items-center justify-between text-white">
                  <div className="inline-flex items-center gap-1.5 sm:gap-2 px-2.5 sm:px-3 py-1 sm:py-1.5 rounded-full bg-black/45 backdrop-blur-md border border-white/20 text-[11px] sm:text-xs font-semibold">
                    ...
                    <span>Global Engineering & AI Lab</span>
                  </div>
          ...
          <div className="lg:col-span-6 lg:pl-2 flex flex-col justify-center">
            ...
            <div className="mt-6 pt-5 sm:mt-8 sm:pt-6 border-t border-gray-200/80 grid grid-cols-3 gap-3 sm:gap-6">
              <div>
                <div className="text-2xl sm:text-3xl lg:text-4xl font-extrabold text-[#004771]">2005</div>
                <div className="text-[11px] sm:text-xs font-semibold text-gray-500 mt-0.5">Year Established</div>
              </div>
              <div>
                <div className="text-2xl sm:text-3xl lg:text-4xl font-extrabold text-[#14B8A6]">500+</div>
                <div className="text-[11px] sm:text-xs font-semibold text-gray-500 mt-0.5">Projects Delivered</div>
              </div>
              <div>
                <div className="text-2xl sm:text-3xl lg:text-4xl font-extrabold text-[#02487D]">90%+</div>
                <div className="text-[11px] sm:text-xs font-semibold text-gray-500 mt-0.5">Repeat Clients</div>
              </div>
            </div>
          </div>
        </div>
